...
class Movie(models.Model):
	...
	content_based_recommendations = models.CharField(null=True, max_length=256, default="")
	collaborative_recommendations = models.CharField(null=True, max_length=256, default="")
